      ...
      <div className={style.about_container}>
        <div className={style.abt_topdiv}>
          <div className={style.abt_desc}>
            ...
            <p>
              The Axon Stroke Foundation is a non-profit organization focused on
        ...
        <div className={style.abt_bottomdiv}>
          ...
          <div className={style.abt_desc}>
            ...
            <p>
              To raise awareness about stroke, provide therapeutic support, and
              advance education and research for better prevention, treatment,
          ...
          <div className={style.abt_topdiv}>
            ...
            <div className={style.abt_desc}>
              ...
              <p>
                <span>Compassion</span> We make a meaningful impact with empathy
                and care for every individual.
              </p>
              <p>
                <span>Empowerment</span> We equip individuals with the knowledge
                and resources for health and recovery.
              </p>
              <p>
                <span> Education</span> We spread knowledge to prevent strokes
                and improve outcomes.
              </p>
              <p>
                <span>Collaboration</span> We work with partners to create
                sustainable change in stroke care.
              </p>
              <p>
                <span>Integrity</span> We maintain transparency and ethics in
                all our efforts.
              </p>
              <button className={style.readMoreButton}>
                Read More
